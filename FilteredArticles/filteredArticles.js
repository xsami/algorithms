...
const filterdWords = ["baseball", "play", "team", "fantasy", "game"];


// TODO: Implement the getFilterArticles function
function getFilterArticles(articles, words) {
    return;
}

console.log(getFilterArticles(exampleArticles, filterdWords));